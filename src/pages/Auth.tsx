...
export function AuthPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (mode === 'register') {
      ...
      if (error) setMessage({ type: 'error', text: 'Špatný email nebo heslo.' })
    }
    setLoading(false)
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 w-full max-w-sm">
        ...
        <button
          ...
          disabled={loading}
          className="w-full mt-4 py-2.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white font-semibold rounded-lg text-sm transition-colors"
        >
